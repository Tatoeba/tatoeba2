...
$transcription = __('Transcription or alternative script');
    ...
    <div>
        ...
        <div class="section md-whiteframe-1dp">
            ...
            <dl>
                ...
                <dd>
                    <?= __(
                        'Contains all transcriptions and alternative scripts. If the '.
                        'username is empty, it means it has been autogenerated by our ' .
                        'tools. Otherwise, it means it has been reviewed by this user. ' .
