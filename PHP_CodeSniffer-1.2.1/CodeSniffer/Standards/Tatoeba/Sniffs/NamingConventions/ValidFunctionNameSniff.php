<?php
/**
 * Tatoeba_Sniffs_NamingConventions_ValidFunctionNameSniff.
 *
 * PHP version 5
 *
 * @category  PHP
 ...
 * @link      http://pear.php.net/package/PHP_CodeSniffer
 */
class Tatoeba_Sniffs_NamingConventions_ValidFunctionNameSniff extends PHP_CodeSniffer_Standards_AbstractScopeSniff
{
    ...
    /**
     * Constructs a Tatoeba_Sniffs_NamingConventions_ValidFunctionNameSniff.
     */
            ...
            if (!in_array($testMethodName,$this->cakePhpMethods)) {
                if (PHP_CodeSniffer::isUnderscoreLowerCaseName($testMethodName) === false) {
                    if ($scopeSpecified === true) {
                        $error = ucfirst($scope)."controller method name \"$className::$methodName\" is not in underscore lower case only format";
                    } else {
                        $error = "Controller method name \"$className::$methodName\" is not in underscore lower case only format";
                    }
