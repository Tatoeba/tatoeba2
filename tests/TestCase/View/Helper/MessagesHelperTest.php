    ...
    public function formatContentProvider() {
        return [
            ...
            [ 'https://a-b',
              'https://a-b' ],
            [ 'https://a-b.com',
              '<a href="https://a-b.com" target="_blank" rel="nofollow">https://a-b.com</a>' ],
            [ 'https://example.com/abc%20(def%20()))',
              '<a href="https://example.com/abc%20(def%20())" target="_blank" rel="nofollow">https://example.com/abc%20(def%20())</a>)' ],
            // The following url contains a white space early ending it and thus
            // contains unbalanced parenthesis; it therefore should not be recognized
            [ 'https://example.com/abc( )',
              'https://example.com/abc( )' ],                
            [ '<a href="http://example.com/">',
              '&lt;a href=&quot;<a href="http://example.com/&quot;&gt;" target="_blank" rel="nofollow">http://example.com/&quot;&gt;</a>' ],
            [ 'A http://example.com and another http://example.com.',
              'A <a href="http://example.com" target="_blank" rel="nofollow">http://example.com</a> and another <a href="http://example.com" target="_blank" rel="nofollow">http://example.com</a>.' ],
            [ 'http://example.com/'."\t".'URL',
              '<a href="http://example.com/" target="_blank" rel="nofollow">http://example.com/</a>'."\t".'URL' ],
            [ 'Yet another URL: https://example.com/abc...',
              'Yet another URL: <a href="https://example.com/abc" target="_blank" rel="nofollow">https://example.com/abc</a>...' ],
            [ 'Link at the end #14',
