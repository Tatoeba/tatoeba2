...
$(document).ready(function() {
    $(document).watch("addrule", function() {
        var context = this;
        $(".translateLink:not(:has(a.disabled))", context).click(function() {
            var sentenceId = $(this).attr("data-sentence-id");
            // Controls
            var submitButton = $("#_" + sentenceId + "_submit", context);
            var cancelButton = $("#_" + sentenceId + "_cancel", context);
            var textArea = $("#_" + sentenceId + "_text", context);
            var langSelect = $("#translationLang_" + sentenceId, context);
            var translations = $("#_" + sentenceId + "_translations", context);
            var addTranslations = $(".addTranslations", context);
            var translationFor = $("#translation_for_" + sentenceId, context);
            var loadingIcon = $("#_" + sentenceId + "_loading", context);
            var sessionExpired = $("#session_expired", context);
         ...
         */
        $( ".language-selector", context).change(function() {
            if ($(this).val()!='auto') {
