...
$(document).ready(function() {
    ...
    $(document).watch("addrule", function() {
        ...
        $('.needsReview:hidden', context).each(function(index) {
            var transcr = $(this);
        ...
        $('.transcriptionContainer.blend', context).each(function() {
            var container = $(this);
        ...
        $('.editable.transcription', context).each(function() {
            var div = $(this);
            var previousValue = {};
            ...
            $(".edit_transcription", context).bind("click", function() {
                $(this).closest('.transcriptionContainer').find('.transcription').trigger("edit_transcription");
            });
        });

        // review button
        $('.transcriptionContainer .option.review', context).click(function() {
