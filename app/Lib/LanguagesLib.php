    ...
    public static function languagesInTatoeba()
    {
        ...
        if (!$languages || $currentLang != $lastLang) {
            ...
            $languages = array(
                ...
                'nan' => __d('languages', 'Chinese (Min Nan)'),
                ...
                'lzh' => __d('languages', 'Chinese (Literary)'),
                ...
                'hak' => __d('languages', 'Chinese (Hakka)'),
                ...
                'hsn' => __d('languages', 'Chinese (Xiang)'),
                'gan' => __d('languages', 'Chinese (Gan)'),
