...
class TranscriptionTestCase extends CakeTestCase {
    ...
    function testGenerateTranscriptionsForCantonese() {
	$yueSentenceId = 11;
        $yueSentence = $this->Transcription->Sentence->findById($yueSentenceId);

        $result = $this->Transcription->generateTranscription($yueSentence, 'Latn');

        $this->assertEqual('autogenerated jyutping', $result[0]['text']);
    }

    function testDoNotSaveTranscriptionsForCantonese() {
        $this->Transcription->deleteAll('1=1');
	$yueSentenceId = 11;
        $yueSentence = $this->Transcription->Sentence->findById($yueSentenceId);
