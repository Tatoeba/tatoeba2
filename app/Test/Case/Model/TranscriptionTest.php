...
class TranscriptionTest extends CakeTestCase {
    ...
    function startTest($method) {
        ...
        $this->AutoTranscr->shouldReceive('jpn_Jpan_to_Hrkt_generate')->andReturn('autogenerated furigana');
        $this->AutoTranscr->shouldReceive('jpn_Jpan_to_Hrkt_validate')->andReturn(true);
        $this->AutoTranscr->shouldReceive(
            'cmn_Hans_to_Hant_generate')->andReturn('converted into traditional characters'
        );
        $this->AutoTranscr->shouldReceive(
            'cmn_Hans_to_Latn_generate')->andReturn('autogenerated pinyin'
        );
        $this->AutoTranscr->shouldReceive(
            'yue_Hant_to_Latn_generate')->andReturn('autogenerated jyutping'
        );
    }
    ...
    function testGenerateTranscriptionCallsGenerator() {
        ...
        $this->AutoTranscr->shouldReceive(
            'jpn_Jpan_to_Hrkt_generate')->with($jpnSentence['Sentence']['text'], true)->once();
    ...
    function testSaveTranscriptionChecksUserProvidedTranscriptionValidityOnCreate() {
        ...
        $this->AutoTranscr = $this->_installAutotranscriptionMock();
        $this->AutoTranscr->shouldReceive('jpn_Jpan_to_Hrkt_validate')->andReturn(false);
    ...
    function testAddGeneratedTranscriptionsDontDoubleGenerate() {
        ...
        $this->Transcription = Mockery::mock();
        $this->Transcription->shouldReceive('generateTranscription')->andReturn(array());
        $this->Transcription->shouldReceive('generateTranscription')->times(1);;
    ...
    function testDetectScriptCallsDetector() {
        ...
        $this->AutoTranscr->shouldReceive(
            'cmn_detectScript')->with($cmnSentence['Sentence']['text'])->once();
