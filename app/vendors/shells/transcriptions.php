...
class TranscriptionsShell extends Shell {
    ...
    private function autogen() {
        echo "Removing all existing autogenerated transcriptions...\n";
        $this->Transcription->deleteAll(
            array('Transcription.user_id' => null),
            false
        );

        echo "Generating new transcriptions";
        $proceeded = $this->allSentencesOperation('_autogen', array(
            'lang' => $this->Transcription->transcriptableLanguages(),
        ));
    ...
    private function die_usage() {
        ...
        die(
            "\nWrite transcription-related information to the database.\n\n".
            "  Usage: $me {script|autogen}\n".
            "Example: $me script\n\n".
            "Parameters:\n".
