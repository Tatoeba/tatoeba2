...
<div id="main_content">
    <div class="module">
        ...
        <ul>
            ...
            <li>Displays a random sentence.
                <ul>
                    <li>Clicking on "show another" will load a new random sentence.</li>
                </ul>
            </li>
            <li>Displays the 10 last contributions.
                <ul>
                    <li>
        ...
        <h4>SEARCH</h4>
        <ul>
            <li>Displays explanations about the search.
                <ul>
                    <li>
        ...
        <h4>CONTRIBUTE</h4>
        <ul>
            <li>Enables members to add a new sentence.
                <ul>
                    <li>
            ...
            <li>Displays a random sentence to translate.
                <ul>
                    <li>
