...
<div id="main_content">
	<div class="module">
		...
		<ul>
			...
			<ul>
				<li>Clicking on "show more" will lead to the list of the 200 last contributions.</li>
				<li>Clicking on "show activity timeline" will show the number of contributions for each day since January 1st, 2008.</li>
			</ul>
			<li>Displays the 5 latest comments (each comment is linked to a specific sentence).</li>
			<ul>
				<li>Clicking on the title of a comment will show all the comments on the sentence.</li>
		...
		<ul>
			...
			<ul>
				<li>After the sentence is added, the user is redirected to the "Browse" section, which will be displaying the sentence the user just added.</li>
			</ul>
			<li>Displays a random sentence to translate.</li>
			<ul>
				<li>After the translation is added, the user is also redirected to the "Browse" section, which will be displaying the sentence from which the user translated.</li>
		...
		<ul>
			...
			<ul>
				<li>Clicking on a username in the list will lead to the information page of the user.</li>
				<li>It's also possible to display the information page of a user by entering a username in the text input.</li>
				<li>Clicking on "random" will show the information page of a random user.</li>
		...
		<ul>
			...
			<ul>
				...
				<li>Based on these logs, we're showing the activity in Tatoeba in the "activity timeline" : it indicates for each day the sum of number of sentences added and the number of modificaitons.</li>
			</ul>
		</ul>
	</div>
</div>
