...
<div id="main_content">
    ...
    <div class="module">
        ...
        <table class="downloads">
            ...
            <tr>
                <td>
                    <div><strong>Download:</strong> 
                        <a href="http://tatoeba.org/files/2010-01-11/sentences_20100111.csv">
                            sentences
                        </a>
                    </div>
            ...
            <tr>
                <td>
                    <div><strong>Download:</strong>
                    <a href="http://tatoeba.org/files/2010-01-11/links_20100111.csv">
                        links
                     </a>
                     </div>
                    <div><strong>Date:</strong> Jan 11th, 2009</div>
                ...
                <td>
                    ...
                    <p>
                        ...
                        <strong>"1";"77"</strong> means that sentence nº77 is the 
                        translation of sentence nº1. The reciprocal link is also 
                        present. In other words, you will also have a line that say
                        <strong>"77";"1"</strong>.
                    </p>
                </td>
            </tr>
            ...
            <tr>
                <td>
                    <div><strong>Download:</strong>
                        <a href="http://tatoeba.org/files/2009-11-06/romaji_20091106.csv">
                            romaji
                        </a>
                    </div>
                ...
                <td>
                    ...
                    <p>
                        Contains the romaji for Japanese sentences. Note that the
                        romaji has been automatically generated and is not always
                        reliable.
                    </p>
                </td>
            </tr> 
            ...
            <tr>
                <td>
                    <div><strong>Download:</strong> 
                    <a href="http://tatoeba.org/files/2010-01-11/jpn_indices_20100111.csv">
                        jpn_indices
                    </a>
                    </div>
                    <div><strong>Date:</strong> Jan 11th, 2009</div>
                ...
                <td>
                    <p>
                        <strong>Fields:</strong> "sentence_id"; "meaning_id", "text"
                    </p>
                    <p>
    ...
    <div class="module">
        ...
        <p>
            The data is provided in CSV files, encoded in UTF-8 without BOM. 
            Fields are terminated by a semi-colon and enclosed by double quotes.
        </p>
        <p>
            ...
            , which belongs to the public domain. In other words, most of 
            the sentences in Tatoeba are from there. Note that this corpus 
            will now be maintained from Tatoeba, so you will find the most 
            up-to-date data here.
        </p>
        <p>
            Some of the sentences are anoted with brackets and Trang was too lazy 
            to strip them off. In case you wonder, they were used to indicate 
            the correspondance of words between a sentence and its translations. 
            For instance <em>I am {happy}{1}</em> and <em>Je suis {content}{1}</em>.
            The brackets here indicate that <em>happy</em> and <em>content</em> mean
            the same thing.
        </p>
    </div>
</div>
