...
<div id="main_content">
    ...
    <p><strong>1)</strong> Contact <a href="/user/profile/TRANG">Trang</a> (by <a href="mailto:team@tatoeba.org">email</a> or <a href="/private_messages/write/TRANG">private message</a>) and indicate in the title the language(s) that you would like us to add.</p>
    ...
    <p><strong>5)</strong> Don't hesitate to ask us if you don't know how to do something!</p>
