 ...
 */
	public function assertRulesFifteen() {
		$singular = $this->__singular();
		$this->assertEqual('Plural Rule 15 (translated)', $singular);

		$plurals = $this->__plural(111);
		...
		$coreSingular = $this->__singularFromCore();
		$this->assertEqual('Plural Rule 15 (from core translated)', $coreSingular);

		$corePlurals = $this->__pluralFromCore(111);
 ...
 * @return void
 */
	function __pluralFromCore($upTo = 25) {
		$plurals = array();
		for ($number = 0; $number <= $upTo; $number++) {
